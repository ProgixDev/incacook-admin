      ...
      <article className="space-y-8">
        ...
        <section className="rounded-2xl border border-outline-variant bg-surface p-5 sm:p-7">
          ...
          <ol className="mt-4 list-decimal space-y-3 pl-5 leading-7 text-on-surface-variant">
            <li>
              Envoyez un e-mail à{" "}
              <a className="text-primary underline underline-offset-2" href="mailto:contact@incacook.com?subject=Demande%20de%20suppression%20de%20donn%C3%A9es%20IncaCook">
